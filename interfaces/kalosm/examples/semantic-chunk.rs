...
async fn main() -> anyhow::Result<()> {
    ...
    for (i, chunk) in chunks.iter().enumerate() {
        println!(
            "CHUNK {}:\n{}\n",
            i,
            &PARAGRAPH[chunk.byte_range.clone()].trim()
        );
    }
...
const PARAGRAPH: &str = r#"Till recently graduating seniors had two choices: get a job or go to grad school. I think there will increasingly be a third option: to start your own startup. But how common will that be?
